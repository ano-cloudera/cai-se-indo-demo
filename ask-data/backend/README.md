...
- The prompt now includes business-aware schema context for a banking customer, deposit, credit, and fraud analytics demo.
- Current prompt constraints allow the `customers`, `deposits`, `credits`, and `fraud_transactions` tables.
...
- Allowed tables are limited to `customers`, `deposits`, `credits`, and `fraud_transactions`.
