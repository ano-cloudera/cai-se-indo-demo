...
const fieldBase =
  "w-full rounded-[16px] border border-[var(--color-border-soft)] bg-[var(--color-surface)] px-4 text-[14px] text-[var(--color-ink-strong)] shadow-[0_1px_2px_rgba(15,23,42,0.02)] transition-colors placeholder:text-[var(--color-ink-subtle)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-action-primary)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-page-bg)]";
