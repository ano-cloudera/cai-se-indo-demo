...
export function AnswerCard({
  ...
  return (
    <section className="max-w-3xl rounded-[30px] border border-[#ffd9b4] bg-[linear-gradient(180deg,rgba(255,249,241,0.96)_0%,rgba(255,255,255,0.96)_44%,rgba(255,245,228,0.94)_100%)] p-6 shadow-[0_22px_46px_rgba(245,158,11,0.08),0_10px_22px_rgba(15,23,42,0.05),inset_0_1px_0_rgba(255,255,255,0.92)] ring-1 ring-[#fff2e1]/80">
